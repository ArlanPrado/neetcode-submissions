    ...
    public List<Integer> rightSideView(TreeNode root) {
        ...
        */
        ...
        while(!nodeQ.isEmpty()) {
            ...
            rightVals.add(latestVal);
        }
        return rightVals;
    } 
    /*
    Time Complexity: O(n), each node has to be accessed and analyzed
    Space Complexity: O(w), w being the largest width of the tree as BFS looks by width and stores nodes of the width 
    */
}
