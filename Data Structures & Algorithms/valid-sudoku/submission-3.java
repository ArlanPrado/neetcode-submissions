class Solution {
    public boolean isValidSudoku(char[][] board) {
        ...
        */
        ...
        for (char[] row : board) {
            HashSet<Character> rowList = new HashSet<>();
            for (int column = 0; column < row.length; column++) {
                ...
                if (value != '.') {
                    ...
                    HashSet<Character> columnChars = columnMap.get(column);
                    if (null == columnChars) {
                        columnMap.put(column, new HashSet<Character>(Set.of(value)));
                    } else {
                    ...
                    HashSet<Character> squareChars =  squareMap.get(leadingSquare);
                    if (null == squareChars) {
                        squareMap.put(leadingSquare, new HashSet<Character>(Set.of(value)));
                    } else {
